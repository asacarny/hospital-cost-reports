...
* If you would like to the variable to sum over non-consecutive lines, add additional entries to the table with the same `rec` and `fmt`. For an example, see  `othspec_beds` for 1996 format reports in the lookup table.
